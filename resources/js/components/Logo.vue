<template>
   ...
   <div class="mb-10">
      ...
      <div class="flex justify-between items-center">
      	...
      	<a href="/logo.svg" class="border border-greylight px-8 py-2 rounded-full text-black font-bold text-xs">logo.svg</a>
      </div>
   </div>
     ...
     <div>
      ...
      <div class="flex justify-between items-center">
      	...
      	<a href="/negative-logo.svg" class="border border-greylight px-8 py-2 rounded-full text-black font-bold text-xs">negative-logo.svg</a>
      </div>
   </div>
